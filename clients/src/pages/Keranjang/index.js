                    ...
                    <Col>
                      <Card.Body styles>
                        <Row Row className="py-1">
                          <Col xs={11}>
                            <Card.Title style={{ margin: "0" }}>{item.namaBarang}</Card.Title>
                          </Col>
                          <Col>
                            <Form.Check aria-label="option 1" id={index} name="barang" value={[item.jumlah, item.harga]} onChange={handleChange} />
                          </Col>
                        </Row>
                        <Row className="py-3">
                        ...
                        <Row style={{ height: "100%" }}>
                          <Col>
                            <span style={{ margin: "0" }}>{item.harga}</span>
                          </Col>
            ...
            <Card body className={Styles.rangkumanBelanja}>
              ...
              <Container>
                <Row style={{ paddingBottom: "15px" }}>
                  ...
                  <Col>
                    <span className={Styles.font}>{total.totalbarang}</span>
                  </Col>
                </Row>
                <Row>
                  <Col>
                  ...
                  <Col>
                    <span className={Styles.font}>Rp. {total.totalharga}</span>
                  </Col>
                </Row>
                <hr style={{ margin: "15px 0px" }}></hr>
                <Row>
